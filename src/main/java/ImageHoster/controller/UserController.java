...
public class UserController {
   ...
   /* This controller method is called when the request pattern is of type 'users/registration' and also
    ...
    */
    ...
    /*This controller method is called
     ...
     The return type of the business logic is changed to User type instead of boolean type. The login() method
     in the business logic checks whether the user with entered username and password exists in the database
     and returns the User type object if user with entered username and password exists in the database,
     else returns null.
     If user with entered username and password exists in the database, direct to user homepage displaying
     all the images in the application.
    ...
    */
    ...
    /*  This controller method is called when the request pattern is of type 'users/logout'
