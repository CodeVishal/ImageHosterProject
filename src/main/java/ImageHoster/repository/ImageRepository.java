...
//The annotation is a special type of @Component annotation which describes
// that the class defines a data repository
...
public class ImageRepository {
    ...
    /* The method creates an instance of EntityManager
   Executes JPQL query to fetch the image from the database with corresponding title & id
    ...
    */
    ...
    /*
        ...
        This changes the state of the image model from detached state to persistent state,
        which is very essential to use the remove() method
