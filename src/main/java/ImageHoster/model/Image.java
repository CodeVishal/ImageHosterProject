...
/*  Write the annotation to specify that the corresponding class is a JPA entity
    ...
    Hence the table named 'images' will be created in the
...
public class Image {
    ...
    //Below annotation indicates that the name of the column in 'images'
    // table referring the primary key in 'users' table will be 'user_id'
