...
/*
    ...
    ere the name of the table to be created in the database is explicitly mentioned as 'Tags'.
...
public class Tag {
    ...
    /*
     Write the annotation for many to many between images and tags where they are mapped
      by tags field in the images table.
